...
const MATERIAL_ICONS = [
  /* ---- specifics that must win over looser patterns below ---- */
  { re: /soil|dirt/i, svg: `<svg viewBox="0 0 40 40"><path d="M4 26 C 8 22, 14 24, 20 22 C 26 20, 32 24, 36 22 L 36 36 L 4 36 z" fill="#6b4a28" stroke="#2e1a08" stroke-width="1.3"/><circle cx="10" cy="30" r="1.2" fill="#3a2410"/><circle cx="16" cy="32" r="1" fill="#3a2410"/><circle cx="22" cy="29" r="1.3" fill="#3a2410"/><circle cx="28" cy="32" r="1" fill="#3a2410"/><path d="M14 26 l1 -3 l1 3 M24 24 l1 -3 l1 3" stroke="#2a6a20" stroke-width="1" fill="none"/></svg>` },
  { re: /sand(?!paper)/i, svg: `<svg viewBox="0 0 40 40"><path d="M4 30 C 12 26, 20 30, 28 26 C 32 25, 36 28, 36 28 L 36 36 L 4 36 z" fill="#e8ce8a" stroke="#8a6a30" stroke-width="1.3"/><circle cx="10" cy="32" r="0.7" fill="#8a6a30"/><circle cx="14" cy="33" r="0.6" fill="#8a6a30"/><circle cx="18" cy="31" r="0.7" fill="#8a6a30"/><circle cx="24" cy="33" r="0.6" fill="#8a6a30"/><circle cx="30" cy="31" r="0.7" fill="#8a6a30"/></svg>` },
  { re: /sandpaper/i, svg: `<svg viewBox="0 0 40 40"><rect x="7" y="8" width="26" height="24" fill="#c49a50" stroke="#5a3a10" stroke-width="1.3"/><circle cx="12" cy="14" r="0.6" fill="#3a2410"/><circle cx="18" cy="13" r="0.7" fill="#3a2410"/><circle cx="24" cy="15" r="0.6" fill="#3a2410"/><circle cx="29" cy="13" r="0.7" fill="#3a2410"/><circle cx="14" cy="20" r="0.6" fill="#3a2410"/><circle cx="21" cy="21" r="0.7" fill="#3a2410"/><circle cx="27" cy="20" r="0.6" fill="#3a2410"/><circle cx="12" cy="27" r="0.7" fill="#3a2410"/><circle cx="19" cy="26" r="0.6" fill="#3a2410"/><circle cx="25" cy="28" r="0.7" fill="#3a2410"/><circle cx="30" cy="26" r="0.6" fill="#3a2410"/></svg>` },
  { re: /paperclip/i, svg: `<svg viewBox="0 0 40 40"><path d="M14 6 v24 a4 4 0 0 0 8 0 v-20 a3 3 0 0 0 -6 0 v18 a2 2 0 0 0 4 0 v-16" fill="none" stroke="#8a8a92" stroke-width="2.2" stroke-linecap="round"/></svg>` },
  { re: /milk/i, svg: `<svg viewBox="0 0 40 40"><path d="M14 6 h12 v6 l3 4 v18 a2 2 0 0 1 -2 2 h-14 a2 2 0 0 1 -2 -2 v-18 l3 -4 z" fill="#ffffff" stroke="#3a2a10" stroke-width="1.3"/><rect x="14" y="20" width="12" height="8" fill="#4a7ba8"/><text x="20" y="26" text-anchor="middle" font-family="serif" font-size="4" fill="#ffffff" font-weight="bold">MILK</text></svg>` },
  { re: /yeast/i, svg: `<svg viewBox="0 0 40 40"><rect x="10" y="10" width="20" height="22" fill="#c48a50" stroke="#5a3a10" stroke-width="1.3"/><rect x="12" y="14" width="16" height="8" fill="#f5e6a0"/><text x="20" y="20" text-anchor="middle" font-family="serif" font-size="4" fill="#5a3a10" font-weight="bold">YEAST</text><circle cx="14" cy="27" r="0.8" fill="#8a6a30"/><circle cx="18" cy="28" r="0.8" fill="#8a6a30"/><circle cx="22" cy="27" r="0.8" fill="#8a6a30"/><circle cx="26" cy="28" r="0.8" fill="#8a6a30"/></svg>` },
  { re: /ziplock|zip.?bag|sandwich bag|plastic bag/i, svg: `<svg viewBox="0 0 40 40"><path d="M10 10 h20 v22 a2 2 0 0 1 -2 2 h-16 a2 2 0 0 1 -2 -2 z" fill="#e8f0f8" stroke="#4a7ba8" stroke-width="1.3" opacity="0.85"/><path d="M10 10 h20" stroke="#4a7ba8" stroke-width="2.5"/><path d="M12 10 v-3 h16 v3" fill="none" stroke="#4a7ba8" stroke-width="1.3"/><path d="M13 14 h14" stroke="#4a7ba8" stroke-width="0.6"/></svg>` },
  { re: /aluminum|aluminium|tin foil|foil/i, svg: `<svg viewBox="0 0 40 40"><rect x="6" y="10" width="28" height="22" fill="#d8d8e0" stroke="#5a5a5e" stroke-width="1.3"/><path d="M8 14 L 32 14 M8 18 l24 0 M8 22 l24 0 M8 26 l24 0 M8 30 l24 0" stroke="#8a8a92" stroke-width="0.6" opacity="0.6"/><path d="M6 10 l4 -4 h24 l-4 4 M34 10 l4 -4 v22 l-4 4" fill="#f0f0f4" stroke="#5a5a5e" stroke-width="1"/></svg>` },
  { re: /plastic wrap|cling|saran/i, svg: `<svg viewBox="0 0 40 40"><rect x="6" y="12" width="28" height="18" rx="1" fill="#cfe4d8" stroke="#3a6a4a" stroke-width="1.2" opacity="0.55"/><path d="M10 14 C 14 18, 18 12, 22 18 C 26 12, 30 18, 34 14" fill="none" stroke="#3a6a4a" stroke-width="0.8" opacity="0.8"/><path d="M6 22 L 34 22 M6 26 L 34 26" stroke="#3a6a4a" stroke-width="0.5" opacity="0.4"/></svg>` },
  { re: /hydrogen peroxide|peroxide/i, svg: `<svg viewBox="0 0 40 40"><rect x="16" y="3" width="8" height="4" fill="#3a2a10"/><path d="M12 7 h16 v3 l2 4 v20 a2 2 0 0 1 -2 2 h-16 a2 2 0 0 1 -2 -2 v-20 l2 -4 z" fill="#7a4020" stroke="#2a1000" stroke-width="1.3"/><rect x="14" y="18" width="12" height="10" fill="#f5e6a0"/><text x="20" y="23" text-anchor="middle" font-family="serif" font-size="3.5" fill="#7a4020" font-weight="bold">H₂O₂</text><text x="20" y="27" text-anchor="middle" font-family="serif" font-size="2.5" fill="#7a4020">3%</text></svg>` },
  { re: /rubbing alcohol|isopropyl|alcohol/i, svg: `<svg viewBox="0 0 40 40"><rect x="16" y="3" width="8" height="4" fill="#3a2a10"/><path d="M12 7 h16 v3 l2 4 v20 a2 2 0 0 1 -2 2 h-16 a2 2 0 0 1 -2 -2 v-20 l2 -4 z" fill="#d8e8ef" stroke="#2e4a7a" stroke-width="1.3" opacity="0.85"/><rect x="14" y="18" width="12" height="10" fill="#ffffff"/><text x="20" y="23" text-anchor="middle" font-family="serif" font-size="3" fill="#2e4a7a" font-weight="bold">ALCOHOL</text><text x="20" y="27" text-anchor="middle" font-family="serif" font-size="2.5" fill="#2e4a7a">70%</text></svg>` },
  { re: /cotton ball/i, svg: `<svg viewBox="0 0 40 40"><circle cx="14" cy="18" r="7" fill="#ffffff" stroke="#8a8a92" stroke-width="1"/><circle cx="24" cy="14" r="6" fill="#ffffff" stroke="#8a8a92" stroke-width="1"/><circle cx="26" cy="24" r="7" fill="#ffffff" stroke="#8a8a92" stroke-width="1"/><circle cx="14" cy="26" r="5" fill="#ffffff" stroke="#8a8a92" stroke-width="1"/><circle cx="16" cy="18" r="1" fill="#d8d8e0"/><circle cx="24" cy="24" r="1" fill="#d8d8e0"/></svg>` },
  { re: /cotton swab|q.?tip/i, svg: `<svg viewBox="0 0 40 40"><rect x="9" y="19" width="22" height="2" fill="#f5f0e0" stroke="#8a6a30" stroke-width="0.6"/><ellipse cx="9" cy="20" rx="4" ry="3" fill="#ffffff" stroke="#8a8a92" stroke-width="0.8"/><ellipse cx="31" cy="20" rx="4" ry="3" fill="#ffffff" stroke="#8a8a92" stroke-width="0.8"/></svg>` },
  { re: /toothpaste/i, svg: `<svg viewBox="0 0 40 40"><path d="M6 16 C 6 14, 8 12, 10 12 h22 a2 2 0 0 1 2 2 v12 a2 2 0 0 1 -2 2 h-22 C 8 28, 6 26, 6 24 z" fill="#ffffff" stroke="#2e4a7a" stroke-width="1.3"/><rect x="32" y="16" width="4" height="8" rx="1" fill="#4a7ba8" stroke="#2e4a7a" stroke-width="1"/><path d="M10 16 h18 M10 20 h18 M10 24 h14" stroke="#4a7ba8" stroke-width="0.6"/><path d="M12 14 C 14 10, 16 10, 18 14" fill="#4a9adf" opacity="0.7"/></svg>` },
  { re: /shampoo/i, svg: `<svg viewBox="0 0 40 40"><rect x="14" y="5" width="12" height="3" rx="1" fill="#3a2a10"/><path d="M12 8 h16 v4 l2 4 v16 a2 2 0 0 1 -2 2 h-16 a2 2 0 0 1 -2 -2 v-16 l2 -4 z" fill="#c4a4df" stroke="#5a2a7a" stroke-width="1.3"/><rect x="14" y="20" width="12" height="8" fill="#ffffff"/><text x="20" y="25" text-anchor="middle" font-family="serif" font-size="3.5" fill="#5a2a7a" font-weight="bold">SHAMPOO</text></svg>` },
  { re: /mouthwash/i, svg: `<svg viewBox="0 0 40 40"><rect x="15" y="4" width="10" height="3" fill="#3a2a10"/><path d="M12 7 h16 v3 l2 4 v20 a2 2 0 0 1 -2 2 h-16 a2 2 0 0 1 -2 -2 v-20 l2 -4 z" fill="#4adfb4" stroke="#1a5a4a" stroke-width="1.3" opacity="0.85"/><rect x="14" y="18" width="12" height="10" fill="#ffffff"/><text x="20" y="24" text-anchor="middle" font-family="serif" font-size="3" fill="#1a5a4a" font-weight="bold">MOUTH</text><text x="20" y="27" text-anchor="middle" font-family="serif" font-size="3" fill="#1a5a4a" font-weight="bold">WASH</text></svg>` },
  { re: /glue stick/i, svg: `<svg viewBox="0 0 40 40"><rect x="15" y="4" width="10" height="4" fill="#d93a3a" stroke="#5a1010" stroke-width="1"/><rect x="13" y="8" width="14" height="28" rx="1" fill="#f5f0e0" stroke="#5a1010" stroke-width="1.3"/><text x="20" y="22" text-anchor="middle" font-family="serif" font-size="4" fill="#d93a3a" font-weight="bold">GLUE</text></svg>` },
  { re: /glue/i, svg: `<svg viewBox="0 0 40 40"><path d="M16 4 h8 v4 l3 4 v22 a2 2 0 0 1 -2 2 h-10 a2 2 0 0 1 -2 -2 v-22 l3 -4 z" fill="#ffffff" stroke="#d8731a" stroke-width="1.3"/><rect x="14" y="18" width="12" height="10" fill="#ffa030"/><text x="20" y="25" text-anchor="middle" font-family="serif" font-size="4" fill="#ffffff" font-weight="bold">GLUE</text><path d="M17 4 l3 -3 l3 3" fill="#d8731a"/></svg>` },
  { re: /crayon/i, svg: `<svg viewBox="0 0 40 40"><path d="M14 8 l12 0 l4 6 v20 a2 2 0 0 1 -2 2 h-16 a2 2 0 0 1 -2 -2 v-20 z" fill="#d93a3a" stroke="#5a1010" stroke-width="1.3"/><path d="M14 8 l12 0 l4 6 h-20 z" fill="#ffffff" stroke="#5a1010" stroke-width="1"/><text x="20" y="28" text-anchor="middle" font-family="serif" font-size="3.5" fill="#ffffff" font-weight="bold">CRAYON</text><path d="M17 4 l6 0 l2 4 h-10 z" fill="#8a2020" stroke="#5a1010" stroke-width="0.6"/></svg>` },
  { re: /popsicle|craft stick|wooden stick/i, svg: `<svg viewBox="0 0 40 40"><rect x="17" y="4" width="6" height="32" rx="3" fill="#d8b070" stroke="#5a3a10" stroke-width="1.2"/><path d="M18 8 v24 M22 8 v24" stroke="#8a6a30" stroke-width="0.4" opacity="0.6"/></svg>` },
  { re: /pipe cleaner|chenille/i, svg: `<svg viewBox="0 0 40 40"><path d="M6 30 C 10 10, 18 34, 22 14 C 26 34, 30 10, 36 22" fill="none" stroke="#d93a80" stroke-width="4" stroke-linecap="round"/><path d="M6 30 C 10 10, 18 34, 22 14 C 26 34, 30 10, 36 22" fill="none" stroke="#ffffff" stroke-width="0.6" stroke-dasharray="1 2" stroke-linecap="round"/></svg>` },
  { re: /nail(?!s? polish)/i, svg: `<svg viewBox="0 0 40 40"><path d="M14 4 h12 v4 l-4 2 v24 l-2 2 l-2 -2 v-24 l-4 -2 z" fill="#a8a8b0" stroke="#3a3a42" stroke-width="1.3"/><ellipse cx="20" cy="6" rx="5" ry="1.5" fill="#c8c8d0" stroke="#3a3a42" stroke-width="0.6"/></svg>` },
  { re: /screw(?!driver)/i, svg: `<svg viewBox="0 0 40 40"><ellipse cx="20" cy="8" rx="7" ry="3" fill="#a8a8b0" stroke="#3a3a42" stroke-width="1.3"/><path d="M13 8 v2 C 14 14, 16 16, 18 18 C 14 20, 18 22, 16 24 C 14 26, 18 28, 16 30 L 20 36 L 24 30 C 22 28, 26 26, 24 24 C 22 22, 26 20, 22 18 C 24 16, 26 14, 27 10 v-2 z" fill="#a8a8b0" stroke="#3a3a42" stroke-width="1"/><path d="M16 6 h8" stroke="#3a3a42" stroke-width="1.4"/></svg>` },
  { re: /rock|stone|pebble/i, svg: `<svg viewBox="0 0 40 40"><path d="M6 30 C 4 22, 10 14, 18 12 C 28 10, 36 20, 34 28 C 32 34, 22 36, 14 34 C 10 33, 7 32, 6 30 z" fill="#8a8a92" stroke="#3a3a42" stroke-width="1.3"/><path d="M10 22 C 14 20, 18 22, 20 18 M26 28 C 28 24, 30 26, 30 22" fill="none" stroke="#5a5a62" stroke-width="0.8" opacity="0.6"/><ellipse cx="15" cy="18" rx="2" ry="1" fill="#b0b0b8" opacity="0.6"/></svg>` },
  { re: /stick|twig|branch/i, svg: `<svg viewBox="0 0 40 40"><path d="M6 32 L 34 8" stroke="#6b4a28" stroke-width="3" stroke-linecap="round"/><path d="M18 20 l-6 -2 M24 14 l4 -6 M14 26 l-4 2" stroke="#6b4a28" stroke-width="2" stroke-linecap="round"/><path d="M6 32 L 34 8" stroke="#3a2a10" stroke-width="0.5" stroke-dasharray="2 3"/></svg>` },
  { re: /pinecone|pine cone/i, svg: `<svg viewBox="0 0 40 40"><ellipse cx="20" cy="22" rx="9" ry="13" fill="#8a5a28" stroke="#3a2a10" stroke-width="1.2"/><path d="M14 14 C 18 16, 22 16, 26 14 M13 18 C 18 20, 22 20, 27 18 M13 22 C 18 24, 22 24, 27 22 M14 26 C 18 28, 22 28, 26 26 M15 30 C 18 32, 22 32, 25 30" fill="none" stroke="#3a2a10" stroke-width="1.2"/><path d="M20 9 v-5 M18 6 l-3 -2 M22 6 l3 -2" stroke="#2a5a1a" stroke-width="1.2"/></svg>` },
